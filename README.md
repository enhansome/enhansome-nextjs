...
[<img src="http://res.cloudinary.com/unicodeveloper/image/upload/v1524776764/next-jslogo.svg" align="right" width="250">](https://github.com/vercel/next.js) ⭐ 141,950 | 🐛 3,663 | 🌐 JavaScript | 📅 2026-08-27

> Curated list of resources: books, videos, articles about using Next.js.

[Next.js](https://github.com/vercel/next.js) ⭐ 141,950 | 🐛 3,663 | 🌐 JavaScript | 📅 2026-08-27: The React Framework.

*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,245 | 🐛 105 | 📅 2026-08-21 list thing. You might also like [awesome-tdd](https://github.com/unicodeveloper/awesome-tdd) ⭐ 814 | 🐛 3 | 📅 2022-01-29.*
...
* [GitHub](https://github.com/vercel/next.js) ⭐ 141,950 | 🐛 3,663 | 🌐 JavaScript | 📅 2026-08-27
* [GitHub discussions for Next.js](https://github.com/vercel/next.js/discussions) ⭐ 141,950 | 🐛 3,663 | 🌐 JavaScript | 📅 2026-08-27
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 37,065 | 🐛 361 | 🌐 TypeScript | 📅 2026-08-27 - React UI + elegant infrastructure for AI Copilots, AI chatbots, and in-app AI agents in your Next.js apps.
* [next-auth](https://github.com/iaincollins/next-auth) ⭐ 28,345 | 🐛 598 | 🌐 TypeScript | 📅 2026-07-22 - Easy authentication for Next.js and Serverless
* [Vercel AI SDK](https://github.com/vercel/ai) ⭐ 26,431 | 🐛 1,714 | 🌐 TypeScript | 📅 2026-08-27 - The AI Toolkit for TypeScript. Build AI-powered applications with React, Next.js, Vue, Svelte, and Node.js.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 679 | 🐛 239 | 🌐 ReScript | 📅 2026-08-26 - An open-source AI coding agent that lives in your browser, enabling visual element selection and plain-English code edits with hot reload.
...
* [shadcn/ui](https://github.com/shadcn/ui) ⭐ 122,212 | 🐛 2,339 | 🌐 TypeScript | 📅 2026-08-26 - Beautifully designed components that you can copy and paste into your apps.
...
* [njt.now.sh](https://njt.now.sh) - npm jump to 🐸 (package navigation shortcuts you dreamed about). Partially statically-rendered, partially deployed as lambda. Automatically updated on each commit to the [github repo](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-26, thanks to Now integration.
