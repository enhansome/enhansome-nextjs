...
[<img src="http://res.cloudinary.com/unicodeveloper/image/upload/v1524776764/next-jslogo.svg" align="right" width="250">](https://github.com/vercel/next.js) ⭐ 141,890 | 🐛 3,963 | 🌐 JavaScript | 📅 2026-08-22

> Curated list of resources: books, videos, articles about using Next.js.

[Next.js](https://github.com/vercel/next.js) ⭐ 141,890 | 🐛 3,963 | 🌐 JavaScript | 📅 2026-08-22: The React Framework.

*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,963 | 🐛 106 | 📅 2026-08-21 list thing. You might also like [awesome-tdd](https://github.com/unicodeveloper/awesome-tdd) ⭐ 813 | 🐛 3 | 📅 2022-01-29.*
...
* [GitHub](https://github.com/vercel/next.js) ⭐ 141,890 | 🐛 3,963 | 🌐 JavaScript | 📅 2026-08-22
* [GitHub discussions for Next.js](https://github.com/vercel/next.js/discussions) ⭐ 141,890 | 🐛 3,963 | 🌐 JavaScript | 📅 2026-08-22
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 36,961 | 🐛 357 | 🌐 TypeScript | 📅 2026-08-22 - React UI + elegant infrastructure for AI Copilots, AI chatbots, and in-app AI agents in your Next.js apps.
* [next-auth](https://github.com/iaincollins/next-auth) ⭐ 28,336 | 🐛 597 | 🌐 TypeScript | 📅 2026-07-22 - Easy authentication for Next.js and Serverless
* [Vercel AI SDK](https://github.com/vercel/ai) ⭐ 26,357 | 🐛 1,757 | 🌐 TypeScript | 📅 2026-08-22 - The AI Toolkit for TypeScript. Build AI-powered applications with React, Next.js, Vue, Svelte, and Node.js.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 672 | 🐛 238 | 🌐 ReScript | 📅 2026-08-22 - An open-source AI coding agent that lives in your browser, enabling visual element selection and plain-English code edits with hot reload.
...
* [@farming-labs/docs](https://github.com/farming-labs/docs) ⭐ 52 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-22 - A modern documentation framework that works. One config file, zero boilerplate.
...
* [shadcn/ui](https://github.com/shadcn/ui) ⭐ 121,858 | 🐛 2,308 | 🌐 TypeScript | 📅 2026-08-21 - Beautifully designed components that you can copy and paste into your apps.
...
* [FIM Agent](https://github.com/fim-ai/fim-agent) ⭐ 1,439 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - AI-powered Connector Hub with a Next.js + shadcn/ui portal frontend. Features agent management, connector configuration, knowledge base, and real-time chat with SSE streaming.
...
* [njt.now.sh](https://njt.now.sh) - npm jump to 🐸 (package navigation shortcuts you dreamed about). Partially statically-rendered, partially deployed as lambda. Automatically updated on each commit to the [github repo](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-22, thanks to Now integration.
