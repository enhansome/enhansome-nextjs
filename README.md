...
[<img src="http://res.cloudinary.com/unicodeveloper/image/upload/v1524776764/next-jslogo.svg" align="right" width="250">](https://github.com/vercel/next.js) ⭐ 141,864 | 🐛 4,086 | 🌐 JavaScript | 📅 2026-08-19

> Curated list of resources: books, videos, articles about using Next.js.

[Next.js](https://github.com/vercel/next.js) ⭐ 141,864 | 🐛 4,086 | 🌐 JavaScript | 📅 2026-08-19: The React Framework.

*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 497,666 | 🐛 102 | 📅 2026-08-18 list thing. You might also like [awesome-tdd](https://github.com/unicodeveloper/awesome-tdd) ⭐ 813 | 🐛 3 | 📅 2022-01-29.*
...
* [GitHub](https://github.com/vercel/next.js) ⭐ 141,864 | 🐛 4,086 | 🌐 JavaScript | 📅 2026-08-19
* [GitHub discussions for Next.js](https://github.com/vercel/next.js/discussions) ⭐ 141,864 | 🐛 4,086 | 🌐 JavaScript | 📅 2026-08-19
...
* [next-postgres-graphql](https://github.com/hasura/graphql-engine/tree/master/community/sample-apps/nextjs-postgres-graphql) ⭐ 32,095 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-08-18 - Create SSR Next.js websites using GraphQL with Postgres (Next.js, Postgres, GraphQL)
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 36,845 | 🐛 347 | 🌐 TypeScript | 📅 2026-08-19 - React UI + elegant infrastructure for AI Copilots, AI chatbots, and in-app AI agents in your Next.js apps.
* [next-auth](https://github.com/iaincollins/next-auth) ⭐ 28,332 | 🐛 596 | 🌐 TypeScript | 📅 2026-07-22 - Easy authentication for Next.js and Serverless
* [Vercel AI SDK](https://github.com/vercel/ai) ⭐ 26,293 | 🐛 1,765 | 🌐 TypeScript | 📅 2026-08-19 - The AI Toolkit for TypeScript. Build AI-powered applications with React, Next.js, Vue, Svelte, and Node.js.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 663 | 🐛 246 | 🌐 ReScript | 📅 2026-08-19 - An open-source AI coding agent that lives in your browser, enabling visual element selection and plain-English code edits with hot reload.
...
* [shadcn/ui](https://github.com/shadcn/ui) ⭐ 121,633 | 🐛 2,307 | 🌐 TypeScript | 📅 2026-08-19 - Beautifully designed components that you can copy and paste into your apps.
* [Taxonomy](https://github.com/shadcn/taxonomy) ⭐ 19,282 | 🐛 219 | 🌐 TypeScript | 📅 2026-04-20 - An example app built using Next.js 13 server components.
* [FIM Agent](https://github.com/fim-ai/fim-agent) ⭐ 1,430 | 🐛 2 | 🌐 Python | 📅 2026-08-19 - AI-powered Connector Hub with a Next.js + shadcn/ui portal frontend. Features agent management, connector configuration, knowledge base, and real-time chat with SSE streaming.
...
* [CourseLit](https://github.com/codelit/courselit) ⭐ 1,255 | 🐛 251 | 🌐 TypeScript | 📅 2026-07-22 - An open source alternative to Thinkific, Teachable etc.
