...
[<img src="http://res.cloudinary.com/unicodeveloper/image/upload/v1524776764/next-jslogo.svg" align="right" width="250">](https://github.com/vercel/next.js) ⭐ 141,788 | 🐛 4,231 | 🌐 JavaScript | 📅 2026-08-15

> Curated list of resources: books, videos, articles about using Next.js.

[Next.js](https://github.com/vercel/next.js) ⭐ 141,788 | 🐛 4,231 | 🌐 JavaScript | 📅 2026-08-15: The React Framework.

*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 496,110 | 🐛 100 | 📅 2026-06-30 list thing. You might also like [awesome-tdd](https://github.com/unicodeveloper/awesome-tdd) ⭐ 813 | 🐛 3 | 📅 2022-01-29.*
...
* [GitHub](https://github.com/vercel/next.js) ⭐ 141,788 | 🐛 4,231 | 🌐 JavaScript | 📅 2026-08-15
* [GitHub discussions for Next.js](https://github.com/vercel/next.js/discussions) ⭐ 141,788 | 🐛 4,231 | 🌐 JavaScript | 📅 2026-08-15
...
* [CopilotKit](https://github.com/CopilotKit/CopilotKit) ⭐ 36,783 | 🐛 341 | 🌐 TypeScript | 📅 2026-08-15 - React UI + elegant infrastructure for AI Copilots, AI chatbots, and in-app AI agents in your Next.js apps.
...
* [Vercel AI SDK](https://github.com/vercel/ai) ⭐ 26,207 | 🐛 1,713 | 🌐 TypeScript | 📅 2026-08-15 - The AI Toolkit for TypeScript. Build AI-powered applications with React, Next.js, Vue, Svelte, and Node.js.
...
* [Frontman](https://github.com/frontman-ai/frontman) ⭐ 659 | 🐛 214 | 🌐 ReScript | 📅 2026-08-15 - An open-source AI coding agent that lives in your browser, enabling visual element selection and plain-English code edits with hot reload.
...
* [next-img](https://github.com/humaans/next-img/) ⭐ 276 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-15 - a plugin for embedding optimized images with ease.
...
* [shadcn/ui](https://github.com/shadcn/ui) ⭐ 121,388 | 🐛 2,284 | 🌐 TypeScript | 📅 2026-08-13 - Beautifully designed components that you can copy and paste into your apps.
...
* [FIM Agent](https://github.com/fim-ai/fim-agent) ⭐ 1,421 | 🐛 1 | 🌐 Python | 📅 2026-08-15 - AI-powered Connector Hub with a Next.js + shadcn/ui portal frontend. Features agent management, connector configuration, knowledge base, and real-time chat with SSE streaming.
...
* [njt.now.sh](https://njt.now.sh) - npm jump to 🐸 (package navigation shortcuts you dreamed about). Partially statically-rendered, partially deployed as lambda. Automatically updated on each commit to the [github repo](https://github.com/kachkaev/njt) ⭐ 318 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-15, thanks to Now integration.
